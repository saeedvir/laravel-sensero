...
`Laravel Sensero` یک داشبورد مانیتورینگ برای پروژه‌های Laravel است که اطلاعات سرور، وضعیت برنامه، ابزارهای نگهداری و چند ابزار عملیاتی را در یک پنل وب ارائه می‌دهد.
